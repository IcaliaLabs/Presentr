//
//  PresentrAnimatedTransitioning.swift
//  OneUP
//
...
class PresentrAnimatedTransitioning: NSObject {
    var isPresenting = false
}

// MARK: UIViewControllerAnimatedTransitioning

extension PresentrAnimatedTransitioning: UIViewControllerAnimatedTransitioning {
